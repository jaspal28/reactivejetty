...
/**
 * This abstract class must be extended by the programmer in order to define
 * Endpoints The programmer must define various Action and then must add each
 * endpoint in the constructor with Endpoints#setEndpoint Each extended class
 * must be set into the ReactiveJ#endpoints
 * 
 * @author demo
 *
 */
